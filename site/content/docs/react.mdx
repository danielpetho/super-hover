...
If you want a reusable hover-like behavior that works on real DOM nodes across layouts, Super Hover handles that for you, with the performance tradeoff that comes from measuring real DOM.
