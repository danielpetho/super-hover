...
**Interactive demo (`swept-hit-test-grid`):** A scrollable two-dimensional grid using `sweptHitTest`. Each crossed cell flashes briefly, even when fast pointer movement or diagonal scrolling would normally skip intermediate cells.
